                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card">
                            ...
                            {!! Form::open(['method'=>'POST','action'=>'RequirementController@store']) !!}
                            <div class="body">
                                <div class="col-12">
                                    <div class="form-group">
                                        {!! Form::label('Requirement Name') !!}
                        ...
                        <div class="table-responsive">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <ul class="pagination mt-2">{!! $requirements->links() !!}</ul>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="edit{{ $data->id }}" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['method'=>'PATCH','action'=>['RequirementController@update',$data->id]]) !!}
...
<div class="modal fade" id="delete{{ $data->id }}" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{ route('requirements.delete',$data->id) }}" class="btn btn-warning"><i class="fa fa-trash-o"></i> Delete Entry</a>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-power-off"></i> Close</button>
            </div>
        </div>
    </div>
